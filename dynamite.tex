...
\item It may be a new unseen value which is neither \code{null} or
  equal to \code{soundData}.  In this case, we exit the loop, remove
...
such as \texttt{store} and \textt{retrieve} calls to the repositories.
