...
\begin{table}
 \caption{Translation Schema from Nomadic Time to DynamiTE \texttt{Process} Subclasses}
...
form of the \linebreak \texttt{DynamiTEContextFactory}.  It in turn probes for
