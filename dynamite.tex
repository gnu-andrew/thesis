...
framework for concurrent systems, giving the second set of novel
contributions (\cont{2.1} through \cont{2.4}) in this thesis.  This
includes the translation from Nomadic Time to a process framework
