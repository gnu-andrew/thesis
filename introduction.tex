...
The \texttt{synchronized} blocks are the equivalent of the use of the
...
compromise; we introduce a new framework (chapter \ref{dynamite}) with
a task-oriented design methodology, while retaining as many familiar
ideas as possible.  Unlike efforts such as \cite{obliq},
\cite{daveturner:phd}, \cite{wojciechowski:phd} and
