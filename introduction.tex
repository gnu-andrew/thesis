...
the part that's relevant here; these are covered in \ref{app:nt} and
\ref{app:dynamite}.  At this juncture, we specify the requirements for
it as follows:
...
Chapter (\ref{mobility}) covers a number of \emph{mobile} calculi,
...
recipient then has knowledge of and can access something which it
...
The second part of the thesis introduces our own research and novel
...
contribution, \cont{1.1}.  We then add a form of structural mobility
to this localised form of CaSE using the primitives of the ambient
calculus (\ref{locmob}); this is contribution \cont{1.2}.
Contribution \cont{1.3} occurs in \ref{procmob}, where we add two
...
of an environ; this is contribution \cont{1.4}.
...
semantics; these form contributions \cont{1.5} and \cont{1.6}.  We
close this section by showing how the properties of prioritisation and
time determinacy hold; this is contribution \cont{1.7}.  We close the
...
Chapter \ref{dynamite} covers the development of the DynamiTE (Dynamic
...
construct; these give contributions \cont{2.1} and \cont{2.2}.  The
...
\cont{2.3}.  In \ref{dyn:evolvers}, contribution \cont{2.4}, the
...
Nomadic Time calculus; this forms contributions \cont{3.1} and
\cont{3.2}.  Contribution \cont{3.3} is found in appendices
...
supporting TNT; this is contribution \cont{3.4}.  The chapter closes
