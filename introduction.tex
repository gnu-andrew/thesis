...
Chapter \ref{mobility} covers a number of \emph{mobile} calculi, where
...
new Typed Nomadic Time calculus; this forms contributions \cont{3.1}
and \cont{3.2}.  Contribution \cont{3.3} is found in appendices
