...
created an impasse in the domain of software engineering.  Over the past
few years, new microprocessors have not seen the same increase in clock
speed that has prevailed over the previous decades.  Instead, the use of
multiple `cores' has become common, due largely to physical limitations
which prevent the individual elements of a single processor core
becoming any smaller.

However, this leads to a problem.  The existing dominant means of
designing software systems are inherently sequential.  The design of
current imperative and object-oriented programming languages are,
at their core, still founded on the principles of early computational
models.  These take a idealised view of events whereby they always
occur sequentially and in isolation.  Both universal
