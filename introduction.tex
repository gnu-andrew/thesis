...
architecture, it is usual for the code to be written in assembly
...
unmaintainable, to the point where the cost of doing so was more than
adopting a different technique, in this case OOP.
