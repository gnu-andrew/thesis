...
changed to include more detail.  Further, it may be worth implementing
the types in a theorem prover and deducing results.
...
semantics to use $\nil : T$, $\Delta : T$, $\Delta_\sigma : T$ and $X :
T$.
